...
func (h *ContentModerationHandler) UpdateConfig(c *gin.Context) {
	...
	cfg, err := h.service.UpdateConfig(c.Request.Context(), service.UpdateContentModerationConfigInput{
		...
		AutoDisableAPIKeysEnabled:  req.AutoDisableAPIKeysEnabled,
		APIKeyBanThreshold:         req.APIKeyBanThreshold,
		APIKeyViolationWindowHours: req.APIKeyViolationWindowHours,
