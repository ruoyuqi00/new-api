...
func (r *accountRepository) UpdateCredentialFields(ctx context.Context, id int64, updates map[string]any) error {
	if len(updates) == 0 {
		return nil
	}
	payload, err := json.Marshal(normalizeJSONMap(updates))
	if err != nil {
		return err
	}
