...
export const STATIC_I18N_KEYS = [
  ...
  'Reset to Default',
  'YUAPI to UAG image site quota sync',
  'Generate a short-lived code for the UAG image site. Paste it into UAG to bind quota only; accounts stay separate. UAG usage is billed locally first, then debited from YUAPI by the sync job.',
  'Quota sync code generated',
  'Generate sync code',
  'Expires at',
