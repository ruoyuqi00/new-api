      ...
      try {
        await handleTestChannel(
          currentRow.id,
          {
            ...
            imageSize:
              endpointType === 'image-generation' ? imageSize : undefined,
        ...
        <div className='max-h-[78vh] space-y-4 overflow-y-auto py-4 pr-1'>
          <div className='grid gap-4 md:grid-cols-2'>
            ...
            {endpointType === 'image-generation' ? (
              <div className='grid gap-2'>
                <Label htmlFor='image-test-size'>{t('Image test size')}</Label>
                <Select
                ...
                >
                  <SelectTrigger id='image-test-size' className='w-full'>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectGroup>
                ...
                <p className='text-muted-foreground text-xs'>
                  {t(
                    'The selected size is sent to every image model tested in this run.'
                  )}
                </p>
              </div>
            ) : null}
