  ...
  return (
    ...
    >
      ...
      {redemptionEnabled ? (
        <div className='space-y-2.5 border-t pt-4 sm:space-y-3 sm:pt-6'>
          {topupLink && (
            <div className='border-primary/30 bg-primary/5 grid gap-4 rounded-lg border p-4 shadow-sm sm:grid-cols-[minmax(0,1fr)_auto] sm:items-center sm:p-5'>
              <div className='min-w-0 space-y-1.5'>
                ...
                <p className='text-muted-foreground text-xs leading-relaxed'>
                  {t(
                    'Purchase a recharge card first, then paste the redemption code below to add funds.'
                  )}
                </p>
              </div>
              <Button
