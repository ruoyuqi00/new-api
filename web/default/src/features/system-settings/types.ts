...
export type ModelSettings = {
  ...
  'image_resolution_price_setting.models': string
  'video_pricing_setting.models': string
...
export type BillingSettings = {
  ...
  AffiliateCreditRebateBasisPoints: number
  TopUpLink: string
...
export type SecuritySettings = {
  ...
  UserConcurrencyLimitEnabled: boolean
  UserConcurrencyLimit: number
  UserConcurrencyLimitGroup: string
