...
export function SidebarModulesSection({
  ...
  const sectionMeta: Record<string, { title: string; description: string }> = {
    ...
    creative: {
      ...
      description: t(
        'Image, video, prompts, assets, and connected canvas workflows.'
      ),
    },
    console: {
  ...
  > = {
    ...
    creative: {
      studio: {
        ...
        description: t(
          'Show the YuCore creative home and media production tools.'
        ),
      },
      canvas: {
        title: t('Infinite Canvas'),
        description: t(
          'Open the YuCore canvas with image and video generation tools.'
        ),
      },
    },
    console: {
