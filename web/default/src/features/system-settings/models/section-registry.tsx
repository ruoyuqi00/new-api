...
function normalizeYucoreMediaAdapter(value: string) {
  return yucoreMediaAdapters.includes(
  ...
  },
  {
    ...
    build: (settings: ModelSettings) => (
      <YucoreMediaSettingsCard
        defaultValues={{
          'yucore_media.adapter': normalizeYucoreMediaAdapter(
            settings['yucore_media.adapter']
          ),
          ...
          'yucore_media.model_capabilities':
            settings['yucore_media.model_capabilities'] ?? '',
          'yucore_media.managed_token_group':
            settings['yucore_media.managed_token_group'] ?? '',
