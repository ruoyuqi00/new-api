...
const adapterOptions = ['mock', 'openai-compatible', 'uag-proxy'] as const
...
function flattenValues(
  ...
  return {
    ...
    'yucore_media.require_real_assets':
      values.yucore_media.require_real_assets,
      ...
      <div className='grid gap-3 lg:grid-cols-3'>
        ...
        <div className='rounded-lg border bg-muted/20 p-3'>
          ...
          <div className='mt-2 flex flex-wrap gap-2'>
            ...
            <Badge variant={health?.real_workflow_ready ? 'default' : 'destructive'}>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input
                    placeholder='http://127.0.0.1:17080'
                    {...field}
                  />
                </FormControl>
                <FormDescription>
