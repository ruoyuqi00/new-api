...
const _systemInfoSchema = z.object({
  ...
  ApiAddress: z.string().url().optional().or(z.literal('')),
...
export function SystemInfoSection({ defaultValues }: SystemInfoSectionProps) {
  ...
  const normalizedDefaults: SystemInfoFormValues = {
    ...
    ApiAddress: normalizeValue(defaultValues.ApiAddress),
    ...
    useSettingsForm<SystemInfoFormValues>({
      ...
      onSubmit: async (_data, changedFields) => {
        ...
        for (const [key, value] of otherEntries) {
          ...
          if (key === 'ServerAddress' || key === 'ApiAddress') {
            v = v.replace(/\/+$/, '')
          }
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      {t(
                        'The public API origin used in exported client configurations. Leave empty to use the server address; do not include /v1.'
                      )}
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea
                          placeholder={t('Welcome to YUAPI...')}
                          rows={6}
                          {...field}
                        />
                      </FormControl>
