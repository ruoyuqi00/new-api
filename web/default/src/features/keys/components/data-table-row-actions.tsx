...
import { getStoredPublicAddresses } from '@/lib/public-addresses'

import { updateApiKeyStatus } from '../api'
import { API_KEY_STATUS, ERROR_MESSAGES, SUCCESS_MESSAGES } from '../constants'
import { encodeConnectionString } from '../lib/config-export'
      ...
      >
        ...
        <DropdownMenuItem
          onClick={async () => {
            const realKey = getCachedRealKey()
            if (!realKey) return
            const { apiAddress } = getStoredPublicAddresses()
            const connStr = encodeConnectionString(realKey, apiAddress)
