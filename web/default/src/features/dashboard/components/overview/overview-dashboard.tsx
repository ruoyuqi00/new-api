...
function SetupGuideBackdrop(props: { compact?: boolean }) {
  return (
    <>
      <div
        className={cn(
          "pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_58%_128%_at_78%_0%,rgba(34,211,238,0.16)_0%,transparent_62%),radial-gradient(ellipse_42%_90%_at_12%_92%,rgba(250,204,21,0.1)_0%,transparent_58%),linear-gradient(112deg,rgba(4,7,14,0.96)_0%,rgba(8,12,22,0.92)_48%,rgba(5,7,12,0.98)_100%)]",
          props.compact
      ...
      <div
        className="pointer-events-none absolute inset-0 bg-linear-to-b from-black/5 via-transparent to-black/65"
        aria-hidden="true"
      />
    </>
  );
...
function DashboardSignalItem(props: { signal: HeroSignal }) {
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-white/[0.035] px-3 py-2.5 backdrop-blur">
...
function StartStepItem(props: {
  ...
  return (
    <li className="relative flex gap-3 pb-2.5 last:pb-0">
      ...
      <Link
        to={props.step.to}
        className="focus-visible:ring-ring group flex min-w-0 flex-1 items-center justify-between gap-3 rounded-2xl border border-white/10 bg-white/[0.035] px-3 py-2.5 text-left text-white shadow-xs transition-colors outline-none hover:border-cyan-200/25 hover:bg-cyan-300/10 focus-visible:ring-2"
      >
...
function RequestPreview(props: {
  ...
  return (
    <motion.div
      ...
      className="yucore-sweep relative overflow-hidden rounded-2xl border border-white/10 bg-black/45 p-3 shadow-sm backdrop-blur"
    >
      {!shouldReduceMotion && (
        <motion.div
...
function QuickActionItem(props: { action: QuickAction }) {
  ...
  return (
    <Button
      variant="outline"
      className="group h-auto justify-start rounded-2xl border-white/10 bg-white/[0.035] px-3 py-3 text-left text-white hover:border-cyan-200/25 hover:bg-cyan-300/10"
  ...
  return (
    <div className="flex flex-col gap-4">
      <CardStaggerContainer className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_28rem]">
        <CardStaggerItem className="yucore-sweep relative overflow-hidden rounded-2xl bg-[#05070c] p-5 text-white shadow-sm sm:p-6">
          <div className="absolute inset-0 bg-[linear-gradient(118deg,rgba(34,211,238,0.18),transparent_34%),linear-gradient(242deg,rgba(167,139,250,0.14),transparent_32%),linear-gradient(135deg,#030406,#0d1221)]" />
          <div className="yucore-grid absolute inset-0 opacity-25" />
          <div className="relative grid gap-6 lg:grid-cols-[minmax(0,1fr)_18.5rem] lg:items-center 2xl:grid-cols-[minmax(0,1fr)_22rem]">
            <div className="min-w-0">
            ...
            <div className="mt-7 grid gap-2 sm:grid-cols-3 xl:grid-cols-1 2xl:grid-cols-3">
      ...
      {setupGuideExpanded ? (
        <CardStaggerContainer className="grid items-stretch gap-4 2xl:grid-cols-[minmax(0,1fr)_22rem]">
          <CardStaggerItem className="yucore-panel yucore-sweep h-full overflow-hidden rounded-2xl text-white">
              ...
              <div className="relative grid gap-5 2xl:grid-cols-[minmax(0,1fr)_21rem]">
                <div className="flex min-w-0 flex-col gap-5">
                  ...
                  <div className="grid gap-3 2xl:grid-cols-[minmax(0,1fr)_12rem]">
                    <ol className="rounded-2xl border border-white/10 bg-black/35 p-2 backdrop-blur">
          ...
          <CardStaggerItem className="yucore-panel h-full rounded-2xl p-4 text-white sm:p-5">
        ...
        <CardStaggerContainer>
          <CardStaggerItem className="yucore-panel yucore-sweep overflow-hidden rounded-2xl text-white">
