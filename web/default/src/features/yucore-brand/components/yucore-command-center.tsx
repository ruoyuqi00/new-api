...
const commandModes: CommandMode[] = [
  ...
  },
  {
    ...
    metrics: [
      { label: "Assets", value: "28", icon: Sparkles },
      { label: "Prompt", value: "Clean", icon: WandSparkles },
...
export function YucoreCommandCenter(props: YucoreCommandCenterProps) {
  ...
  return (
    <div className={cn("yucore-command-deck relative", props.className)}>
      ...
      <div className="yucore-command-orbit absolute left-1/2 top-1/2 hidden size-[34rem] -translate-x-1/2 -translate-y-1/2 rounded-full min-[920px]:block" />
        ...
        <div className="relative overflow-hidden rounded-[1.25rem] border border-white/10 bg-black/35">
          ...
          <div className="grid gap-3 p-3 sm:p-4">
            <div className="yucore-holo-stage relative min-h-[13.5rem] overflow-hidden rounded-[1.1rem] border border-white/10 bg-[#030406]">
              ...
              <div className="yucore-holo-radar absolute left-1/2 top-1/2 size-52 -translate-x-1/2 -translate-y-1/2 rounded-full" />
              <div className="yucore-holo-beam absolute left-1/2 top-1/2 h-px w-[72%] -translate-x-1/2 -translate-y-1/2" />
              <div className="yucore-holo-beam yucore-holo-beam-vertical absolute left-1/2 top-1/2 h-px w-[58%] -translate-x-1/2 -translate-y-1/2" />
              <div className="absolute left-1/2 top-1/2 flex size-28 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-white/15 bg-white/[0.035]">
                <div className="yucore-holo-core flex size-20 items-center justify-center rounded-full">
                  <ActiveIcon className="size-7 text-white" aria-hidden="true" />
                </div>
              </div>
              ...
              <div className="absolute left-4 top-4 rounded-full border border-cyan-300/20 bg-cyan-300/10 px-2.5 py-1 text-[11px] text-cyan-100">
                {t("model mesh")}
              </div>
              <div className="absolute right-4 top-8 rounded-full border border-amber-300/20 bg-amber-300/10 px-2.5 py-1 text-[11px] text-amber-100">
                {t("quota lock")}
              </div>
