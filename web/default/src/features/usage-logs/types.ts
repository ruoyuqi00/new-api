...
export interface LogOtherData {
  ...
  frt?: number
  // Expression billing fields, set by backend for tiered_expr and
  // per_call_expr. expr_b64 is the base64-encoded expression and matched_tier
  // is the label of the tier that fired.
  billing_mode?: string
  expr_b64?: string
  matched_tier?: string
