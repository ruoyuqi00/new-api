...
export function Search({ className = '', placeholder }: SearchProps) {
  ...
  return (
    ...
    >
      ...
      <kbd className='bg-muted group-hover:bg-accent pointer-events-none absolute end-[0.3rem] top-[0.3rem] hidden h-5 min-w-11 items-center justify-center rounded border px-1.5 font-mono text-[10px] font-medium opacity-100 select-none sm:flex'>
        Ctrl {t('K')}
      </kbd>
    </Button>
  )
