...
export function AppHeader({
  ...
  return (
    <>
      <Header className='yucore-workbench-header'>
        ...
        {rightContent ?? (
          <div className='yucore-workbench-actions ms-auto flex items-center gap-1 sm:gap-2'>
            {showTopNav && (
              <div className='me-1 hidden lg:block'>
                <TopNav links={links} className='yucore-workbench-topnav' />
              </div>
            )}
            {showSearch && <Search className='yucore-workbench-search' />}
            {showNotifications && (
              <NotificationPopover
