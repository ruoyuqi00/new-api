...
func setupLogin(user *model.User, c *gin.Context) {
	setupLoginAtAuthVersionWithSuccess(user, 0, c, nil)
}

func setupLoginAtAuthVersion(user *model.User, expectedAuthVersion int64, c *gin.Context) {
	setupLoginAtAuthVersionWithSuccess(user, expectedAuthVersion, c, nil)
}

func setupLoginAtAuthVersionWithSuccess(user *model.User, expectedAuthVersion int64, c *gin.Context, beforeResponse func()) {
...
func GetUserModels(c *gin.Context) {
	...
	case "":
		for usableGroup := range usableGroups {
			groupsToQuery = append(groupsToQuery, usableGroup)
		}
	case "auto":
