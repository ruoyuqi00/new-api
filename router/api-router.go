...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		yucoreMediaAssetRoute := apiRouter.Group("/yucore/media")
		yucoreMediaAssetRoute.Use(middleware.TryUserAuth())
		{
		...
		{
			canvasRoute := yucoreRoute.Group("/canvas")
			{
				canvasRoute.GET("", controller.ListYucoreCanvases)
				canvasRoute.POST("", controller.CreateYucoreCanvas)
				canvasRoute.GET("/identity", controller.GetYucoreCanvasIdentity)
				canvasRoute.GET("/:id", controller.GetYucoreCanvas)
				canvasRoute.PUT("/:id", controller.UpdateYucoreCanvas)
				canvasRoute.DELETE("/:id", controller.DeleteYucoreCanvas)
				canvasRoute.GET("/:id/versions", controller.ListYucoreCanvasVersions)
				canvasRoute.GET("/:id/agent-runs", controller.ListYucoreCanvasAgentRuns)
				canvasRoute.POST("/:id/agent-runs", controller.CreateYucoreCanvasAgentRun)
				canvasRoute.POST("/:id/agent-runs/execute", controller.ExecuteYucoreCanvasAgentRun)
				canvasRoute.PATCH("/:id/agent-runs/:run_id", controller.UpdateYucoreCanvasAgentRun)
			}
			...
			mediaRoute.Use(middleware.WriteYucoreMediaAccessCookie())
			{
				...
				mediaTasksRoute := mediaRoute.Group("/tasks")
				{
					...
					mediaTasksRoute.POST("", controller.CreateYucoreMediaTask)
					mediaTasksRoute.GET("/:task_id", controller.GetYucoreMediaTask)
					mediaTasksRoute.PATCH("/:task_id", controller.UpdateYucoreMediaTask)
					mediaTasksRoute.DELETE("/:task_id", controller.DeleteYucoreMediaTask)
				}
			}
		}
		...
		quotaSyncRoute := apiRouter.Group("/quota_sync")
		quotaSyncRoute.Use(middleware.CORS(), middleware.CriticalRateLimit())
		{
			quotaSyncRoute.POST("/redeem", controller.RedeemQuotaSyncCode)
			quotaSyncRoute.GET("/snapshot", controller.GetQuotaSyncSnapshot)
			quotaSyncRoute.POST("/debit", controller.DebitQuotaSync)
		}
		...
		systemTaskRoute.Use(middleware.RootAuth())
		{
			...
			systemTaskRoute.POST("/log-cleanup/resume", controller.ResumeLogCleanupSystemTask)
			systemTaskRoute.POST("/sensitive-input-cleanup", controller.CreateSensitiveInputCleanupSystemTask)
		...
		{
			groupRoute.GET("/catalog", controller.GetGroupCatalog)
