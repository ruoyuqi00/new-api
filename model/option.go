...
func InitOptionMap() {
	...
	common.OptionMap["ApiAddress"] = system_setting.APIAddress
	...
	common.OptionMap["AffiliateCreditRebateEnabled"] = strconv.FormatBool(common.AffiliateCreditRebateEnabled)
	common.OptionMap["AffiliateCreditRebateBasisPoints"] = strconv.Itoa(common.AffiliateCreditRebateBasisPoints)
	...
	common.OptionMap["UserConcurrencyLimit"] = strconv.Itoa(setting.UserConcurrencyLimit)
	...
	common.OptionMap["yucore_media.adapter"] = common.GetEnvOrDefaultString("YUCORE_MEDIA_ADAPTER", "mock")
	common.OptionMap["yucore_media.base_url"] = common.GetEnvOrDefaultString("YUCORE_MEDIA_BASE_URL", "")
	common.OptionMap["yucore_media.api_key"] = common.GetEnvOrDefaultString("YUCORE_MEDIA_API_KEY", "")
	common.OptionMap["yucore_media.timeout_seconds"] = strconv.Itoa(common.GetEnvOrDefault("YUCORE_MEDIA_TIMEOUT_SECONDS", 90))
	common.OptionMap["yucore_media.require_real_assets"] = strconv.FormatBool(common.GetEnvOrDefaultBool("YUCORE_MEDIA_REQUIRE_REAL_ASSETS", false))
	common.OptionMap["yucore_media.model_capabilities"] = common.GetEnvOrDefaultString("YUCORE_MEDIA_MODEL_CAPABILITIES", "")
	common.OptionMap["yucore_media.managed_token_group"] = common.GetEnvOrDefaultString("YUCORE_MEDIA_MANAGED_TOKEN_GROUP", "")
	common.OptionMap["yucore_media.uag_model_map"] = common.GetEnvOrDefaultString("YUCORE_MEDIA_UAG_MODEL_MAP", "")
	common.OptionMap["yucore_media.uag_allowed_providers"] = common.GetEnvOrDefaultString("YUCORE_MEDIA_UAG_ALLOWED_PROVIDERS", "")
	common.OptionMap["yucore_media.uag_allowed_models"] = common.GetEnvOrDefaultString("YUCORE_MEDIA_UAG_ALLOWED_MODELS", "")
	common.OptionMap["yucore_media.upstream_verified"] = strconv.FormatBool(common.GetEnvOrDefaultBool("YUCORE_MEDIA_UPSTREAM_VERIFIED", false))
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "ApiAddress":
		system_setting.APIAddress = value
	case "WorkerUrl":
	...
	case "AffiliateCreditRebateEnabled":
		common.AffiliateCreditRebateEnabled, _ = strconv.ParseBool(value)
	case "AffiliateCreditRebateBasisPoints":
		common.AffiliateCreditRebateBasisPoints, _ = strconv.Atoi(value)
	...
	case "UserConcurrencyLimit":
		setting.UserConcurrencyLimit, _ = strconv.Atoi(value)
	case "UserConcurrencyLimitGroup":
		err = setting.UpdateUserConcurrencyLimitGroupByJSONString(value)
	case "RetryTimes":
