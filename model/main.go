...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&ChannelAccountPoolBinding{}, "ChannelAccountPoolBinding"},
		{&Token{}, "Token"},
		{&User{}, "User"},
		...
		{&Checkin{}, "Checkin"},
		{&QuotaSyncCode{}, "QuotaSyncCode"},
		{&QuotaSyncToken{}, "QuotaSyncToken"},
		{&QuotaSyncDebit{}, "QuotaSyncDebit"},
...
func clickHouseActualResponseModelMigrationSQL() string {
	return "ALTER TABLE logs ADD COLUMN IF NOT EXISTS actual_response_model Nullable(String)"
}
