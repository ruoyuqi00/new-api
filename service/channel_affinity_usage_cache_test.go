...
func newChannelAffinityUsageCacheTestID() string {
	return fmt.Sprintf("%d_%d", time.Now().UnixNano(), atomic.AddUint64(&channelAffinityUsageCacheTestSequence, 1))
}
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	testID := newChannelAffinityUsageCacheTestID()
	ruleName := "rule_" + testID
	usingGroup := "default"
	keyFP := "fp_" + testID
