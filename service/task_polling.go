...
// sweepUnrefundedFailedTasks retries refunds for failed tasks that still carry
// a non-zero quota marker. Claiming the marker first prevents concurrent sweep
// workers from issuing the same refund twice.
