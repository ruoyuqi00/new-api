...
func GenerateTextOtherInfo(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, modelRatio, groupRatio, completionRatio float64,
	...
	if relayInfo.IsModelMapped {
		...
		if forwardedModelName == "" {
			forwardedModelName = relayInfo.UpstreamModelName
		}
		other["upstream_model_name"] = forwardedModelName
	}
	...
	if accountPoolId := common.GetContextKeyInt(ctx, constant.ContextKeyAccountPoolId); accountPoolId > 0 {
		adminInfo["account_pool_id"] = accountPoolId
		adminInfo["provider_account_id"] = common.GetContextKeyInt(ctx, constant.ContextKeyProviderAccountId)
		adminInfo["provider_account_name"] = common.GetContextKeyString(ctx, constant.ContextKeyProviderAccountName)
	}
