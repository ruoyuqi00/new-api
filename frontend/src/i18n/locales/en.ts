export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      windsurfImportResultSummary: 'Submitted {total}, forwarded {forwarded}, duplicates {duplicate_count}',
      windsurfImportSuccess: 'Windsurf import completed: forwarded {forwarded}, duplicates {duplicate_count}',
