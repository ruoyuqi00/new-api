export default {
  ...
  nav: {
    ...
    accounts: 'Accounts',
    providerAdapters: 'Adapter Admin',
    proxies: 'Proxies',
  ...
  admin: {
    ...
    riskControl: {
      ...
      autoDisableApiKeys: 'Auto Disable Downstream Key',
      autoDisableApiKeysHint: 'Disable only the offending downstream API key after repeated risk hits in the window, without affecting other normal keys.',
      banThreshold: 'Ban Threshold',
      violationWindowHours: 'Count Window (hours)',
      apiKeyBanThreshold: 'Key Disable Threshold',
      apiKeyViolationWindowHours: 'Key Count Window (hours)',
    ...
    accounts: {
      ...
      providerAdapters: 'Adapter Admin',
      providerAdaptersTitle: 'Adapter Admin',
      providerAdaptersHint: 'Reads internal adapter admin APIs through the Sub2API admin session. Results are redacted; native admin UIs open through same-domain paths, while Windsurf/Kiro container ports remain private.',
      providerAdaptersOpenWindsurf: 'Open Windsurf Console',
      providerAdaptersOpenKiro: 'Open Kiro Admin',
      providerAdaptersRefresh: 'Refresh',
      providerAdaptersLoading: 'Loading...',
      providerAdaptersRaw: 'Raw Response',
      providerAdaptersLoadFailed: 'Failed to load adapter admin data',
      providerAdaptersEmpty: 'No response',
      providerAdaptersUnavailableCredits: 'This adapter does not expose quota fields yet',
      windsurfImport: 'Import Windsurf',
      windsurfImportTitle: 'Import Windsurf Accounts',
      windsurfImportHint: 'Forward Windsurf credentials to the internal WindsurfAPI service while keeping Sub2API as the only public entry.',
      windsurfImportWarning: 'Credentials are sent through the admin API and are not printed to the browser console. Use this only on a trusted admin page and clear temporary text after importing.',
      windsurfImportMode: 'Import mode',
      windsurfImportModeToken: 'Token',
      windsurfImportModeTokenDesc: 'One Windsurf token per line',
      windsurfImportModeApiKey: 'API Key',
      windsurfImportModeApiKeyDesc: 'One Codeium/Windsurf key per line',
      windsurfImportModeEmailPassword: 'Email Password',
      windsurfImportModeEmailPasswordDesc: 'email----password',
      windsurfImportModeJson: 'JSON',
      windsurfImportModeJsonDesc: 'Full request body',
      windsurfImportInput: 'Credentials',
      windsurfImportTokenPlaceholder: 'token-1\ntoken-2',
      windsurfImportApiKeyPlaceholder: 'api-key-1\napi-key-2',
      windsurfImportEmailPasswordPlaceholder: 'user-a@example.com----password-a\nuser-b@example.com----password-b',
      windsurfImportJsonPlaceholder: '{"accounts":[{"token":"token-1"},{"api_key":"api-key-1"}]}',
      windsurfImportTokenHelp: 'Newlines, commas, and semicolons are accepted. Duplicates are removed by the backend.',
      windsurfImportApiKeyHelp: 'Submits values as api_key so they are not treated as plain tokens.',
      windsurfImportEmailPasswordHelp: 'Each line must separate email and password with four hyphens.',
      windsurfImportJsonHelp: 'Submit any full backend-supported object, or an array of accounts.',
      windsurfImportButton: 'Start Import',
      windsurfImporting: 'Importing...',
      windsurfImportResult: 'Import Result',
      windsurfImportResultBadge: 'Succeeded {succeeded} / Failed {failed}',
      windsurfImportResultSummary: 'Submitted {total}, forwarded {forwarded}, succeeded {succeeded}, failed {failed}, duplicates {duplicate_count}',
      windsurfImportSuccess: 'Windsurf import completed: succeeded {succeeded}, duplicates {duplicate_count}',
      windsurfImportCompletedWithErrors: 'Windsurf import completed with errors: succeeded {succeeded}, failed {failed}',
      windsurfImportFailed: 'Windsurf import failed',
      windsurfImportEmpty: 'Enter Windsurf credentials to import',
      windsurfImportInvalidJson: 'Failed to parse JSON',
      windsurfImportInvalidJsonShape: 'JSON must be an object or an account array',
      windsurfImportInvalidEmailPassword: 'Email/password lines must use email----password format',
      kiroImport: 'Import Kiro',
      ...
      kiroImportModeApiKey: 'API Key',
      kiroImportModeApiKeyDesc: 'One ksk_ Kiro API key per line',
      kiroImportModeJson: 'JSON',
      kiroImportModeJsonDesc: 'Full request body',
      kiroImportInput: 'Credentials',
      kiroImportRefreshTokenPlaceholder: 'refresh-token-1\nrefresh-token-2\nuser@example.com----refresh-token-3',
      kiroImportApiKeyPlaceholder: 'ksk_xxx\nuser@example.com----ksk_yyy',
      kiroImportJsonPlaceholder: '{"accounts":[{"refreshToken":"refresh-token-1","authMethod":"social"},{"kiroApiKey":"ksk_xxx"}]}',
      kiroImportRefreshTokenHelp: 'Newlines, commas, and semicolons are accepted. Use email----refreshToken to include a display email.',
      kiroImportApiKeyHelp: 'Submits values as kiroApiKey and marks them as api_key credentials.',
      kiroImportJsonHelp: 'Submit any full backend-supported object, or an account array. IdC credentials need clientId/clientSecret.',
      kiroImportButton: 'Start Import',
      kiroImporting: 'Importing...',
      kiroImportResult: 'Import Result',
      kiroImportResultBadge: 'Succeeded {succeeded} / Failed {failed}',
      kiroImportResultSummary: 'Submitted {total}, forwarded {forwarded}, succeeded {succeeded}, failed {failed}, duplicates {duplicate_count}',
      kiroImportSuccess: 'Kiro import completed: succeeded {succeeded}, duplicates {duplicate_count}',
      kiroImportCompletedWithErrors: 'Kiro import completed with errors: succeeded {succeeded}, failed {failed}',
      kiroImportFailed: 'Kiro import failed',
      kiroImportEmpty: 'Enter Kiro credentials to import',
      kiroImportInvalidJson: 'Failed to parse JSON',
      kiroImportInvalidJsonShape: 'JSON must be an object or an account array',
      kiroImportInvalidCredentialLine: 'Credential lines must be credential or email----credential',
      ...
      oauth: {
        ...
        openai: {
          ...
          codexSessionReadingFiles: 'Reading files...',
          codexSessionFilesLoaded: '{count} files loaded',
