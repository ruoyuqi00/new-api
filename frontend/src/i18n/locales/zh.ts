export default {
  ...
  admin: {
    ...
    riskControl: {
      ...
      autoDisableApiKeys: '自动禁用下游 Key',
      autoDisableApiKeysHint: '同一个下游 API Key 在窗口内多次命中风险规则后，只禁用该 Key，不影响其他正常 Key。',
      banThreshold: '封禁触发次数',
      violationWindowHours: '累计窗口（小时）',
      apiKeyBanThreshold: 'Key 禁用触发次数',
      apiKeyViolationWindowHours: 'Key 累计窗口（小时）',
    ...
    accounts: {
      ...
      providerAdapters: '适配器后台',
      providerAdaptersTitle: '适配器后台',
      providerAdaptersHint: '通过 Sub2API 管理员会话读取内网适配器管理接口。结果已脱敏；原生后台可通过同域名子路径打开，Windsurf/Kiro 容器端口仍不直接暴露到公网。',
      providerAdaptersOpenWindsurf: '打开 Windsurf 控制台',
      providerAdaptersOpenKiro: '打开 Kiro 后台',
      providerAdaptersRefresh: '刷新',
      providerAdaptersLoading: '读取中...',
      providerAdaptersRaw: '原始返回',
      providerAdaptersLoadFailed: '适配器后台读取失败',
      providerAdaptersEmpty: '暂无返回',
      providerAdaptersUnavailableCredits: '该适配器当前未暴露额度字段',
      windsurfImport: '导入 Windsurf',
      windsurfImportTitle: '导入 Windsurf 账号',
      windsurfImportHint: '将 Windsurf 凭据转发到内网 WindsurfAPI，公网入口仍然只暴露 Sub2API。',
      windsurfImportWarning: '凭据只会通过管理员接口发送到服务器，不会写入浏览器控制台。请确认当前页面环境可信，导入后清空临时文本。',
      windsurfImportMode: '导入方式',
      windsurfImportModeToken: 'Token',
      windsurfImportModeTokenDesc: '一行一个 Windsurf token',
      windsurfImportModeApiKey: 'API Key',
      windsurfImportModeApiKeyDesc: '一行一个 Codeium/Windsurf key',
      windsurfImportModeEmailPassword: '邮箱密码',
      windsurfImportModeEmailPasswordDesc: 'email----password',
      windsurfImportModeJson: 'JSON',
      windsurfImportModeJsonDesc: '完整请求结构',
      windsurfImportInput: '凭据内容',
      ...
      windsurfImportTokenHelp: '支持换行、英文逗号或分号分隔；重复项会由后端去重。',
      windsurfImportApiKeyHelp: '会按 api_key 字段提交，避免被误当作普通 token。',
      windsurfImportEmailPasswordHelp: '每行必须使用四个短横线分隔邮箱和密码。',
      windsurfImportJsonHelp: '可提交后端支持的完整对象，或账号数组。',
      windsurfImportButton: '开始导入',
      windsurfImporting: '导入中...',
      windsurfImportResult: '导入结果',
      windsurfImportResultBadge: '成功 {succeeded} / 失败 {failed}',
      windsurfImportResultSummary: '提交 {total} 个，转发 {forwarded} 个，成功 {succeeded} 个，失败 {failed} 个，重复 {duplicate_count} 个',
      windsurfImportSuccess: 'Windsurf 导入完成：成功 {succeeded} 个，重复 {duplicate_count} 个',
      windsurfImportCompletedWithErrors: 'Windsurf 导入完成但有失败：成功 {succeeded} 个，失败 {failed} 个',
      windsurfImportFailed: 'Windsurf 导入失败',
      windsurfImportEmpty: '请输入要导入的 Windsurf 凭据',
      windsurfImportInvalidJson: 'JSON 解析失败',
      windsurfImportInvalidJsonShape: 'JSON 必须是对象或账号数组',
      windsurfImportInvalidEmailPassword: '邮箱密码行必须是 email----password 格式',
      kiroImport: '导入 Kiro',
      ...
      kiroImportModeApiKeyDesc: '一行一个 ksk_ Kiro API Key',
      kiroImportModeJson: 'JSON',
      kiroImportModeJsonDesc: '完整请求结构',
      kiroImportInput: '凭据内容',
      ...
      kiroImportRefreshTokenHelp: '支持换行、英文逗号或分号分隔；也可用 email----refreshToken 给凭据附带邮箱标识。',
      kiroImportApiKeyHelp: '会按 kiroApiKey 字段提交，并自动标记为 api_key 认证方式。',
      kiroImportJsonHelp: '可提交后端支持的完整对象，或账号数组；IdC 凭据需提供 clientId/clientSecret。',
      kiroImportButton: '开始导入',
      kiroImporting: '导入中...',
      kiroImportResult: '导入结果',
      kiroImportResultBadge: '成功 {succeeded} / 失败 {failed}',
      kiroImportResultSummary: '提交 {total} 个，转发 {forwarded} 个，成功 {succeeded} 个，失败 {failed} 个，重复 {duplicate_count} 个',
      kiroImportSuccess: 'Kiro 导入完成：成功 {succeeded} 个，重复 {duplicate_count} 个',
      kiroImportCompletedWithErrors: 'Kiro 导入完成但有错误：成功 {succeeded} 个，失败 {failed} 个',
      kiroImportFailed: 'Kiro 导入失败',
      kiroImportEmpty: '请输入要导入的 Kiro 凭据',
      kiroImportInvalidJson: 'JSON 解析失败',
      kiroImportInvalidJsonShape: 'JSON 必须是对象或账号数组',
      kiroImportInvalidCredentialLine: '凭据行格式必须是 credential 或 email----credential',
      ...
      oauth: {
        ...
        openai: {
          ...
          codexSessionReadingFiles: '读取文件中...',
          codexSessionFilesLoaded: '已读取 {count} 个文件',
