              ...
              <div class="relative" ref="accountToolsDropdownRef">
                ...
                >
                  <div class="max-h-[70vh] overflow-y-auto p-2">
                    ...
                    <button class="account-tools-menu-item" @click="openWindsurfImport">
                      <span class="account-tools-menu-icon bg-cyan-50 text-cyan-600 dark:bg-cyan-900/30 dark:text-cyan-300">
                        <Icon name="cloud" size="sm" />
                      </span>
                      <span class="flex-1 text-left">{{ t('admin.accounts.windsurfImport') }}</span>
                    </button>
                    <button class="account-tools-menu-item" @click="openKiroImport">
...
const openWindsurfImport = () => {
  closeAccountToolsDropdown()
  showWindsurfImport.value = true
}
...
const handleWindsurfImported = () => { showWindsurfImport.value = false; reload() }
