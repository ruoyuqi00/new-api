...
function resultLabel(row: ContentModerationLog): string {
  if (row.action === 'builtin_rule_block') return t('admin.riskControl.action.builtinRuleBlock')
  if (row.action === 'builtin_rule_hit') return t('admin.riskControl.action.builtinRuleHit')
...
function resultBadgeClass(row: ContentModerationLog): string {
  if (row.action === 'block' || row.action === 'keyword_block' || row.action === 'builtin_rule_block') return 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300'
