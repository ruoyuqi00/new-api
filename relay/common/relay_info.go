...
type RelayInfo struct {
	...
	// PreservePreConsumedQuota prevents an accepted but incomplete upstream stream
	// from settling below the quota already reserved for that request.
	PreservePreConsumedQuota bool
	...
	// ForwardedModelName snapshots the final request model before response
	// handlers can update provider-specific relay state.
	ForwardedModelName  string
