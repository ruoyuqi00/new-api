...
// ReplayableBody is an outbound body that can be recreated for a transport retry.
...
// NewReplayableBodyReader exposes replay without exposing storage ownership.
